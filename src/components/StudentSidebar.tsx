...
import { FaSignOutAlt, FaUserGraduate, FaBars, FaTimes, FaCog, FaFlask, FaBookOpen, FaFileAlt, FaCalendarAlt, FaChalkboard, FaTasks } from "react-icons/fa";
...
export default function StudentSidebar() {
    ...
    const navLinks = [
        ...
        { href: "/student/assignments", label: "My Assignments", icon: <FaTasks /> },
