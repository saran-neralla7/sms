...
export default function StudentHoverCard({ name, rollNumber, studentId, children, className = "" }: StudentHoverCardProps) {
    return (
        <div className={`group relative inline-block ${className}`}>
            ...
            {/* Hover Card */}
            <div className="absolute left-1/2 top-full z-50 mt-2 hidden w-64 -translate-x-1/2 flex-col rounded-xl border border-slate-200 bg-white p-4 shadow-xl ring-1 ring-black/5 group-hover:flex animate-in fade-in zoom-in-95 duration-200">
                {/* Arrow */}
